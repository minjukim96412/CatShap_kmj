				...
				<div class="details1">
					<div class="backgroundborder-parent">
						<div class="backgroundborder14">
							...
							<img class="icon163" alt="" src="./common/icon-171@2x.png" />
						</div>
						<!-- 이용약관 모달 창 -->
					...
					<div class="backgroundborder14">
						...
						<img class="icon163" alt="" src="./common/icon-181@2x.png" />
					...
					<div class="link-parent11">
						<button class="link75" id="joinBtn">
							<div class="action-icons">
								<img class="icon165" src="./common/icon-6.svg" />
							</div>
							<div class="div344">회원가입</div>
						</button>
						<div class="link76" id="userCancelBtn">
							<div class="icon-wrapper26">
								<img class="link-icon29" alt="" src="./common/icon-201.svg" />
							</div>
