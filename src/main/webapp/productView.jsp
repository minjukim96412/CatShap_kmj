  ...
  <jsp:include page="header.jsp"></jsp:include>
    <div class="div63">
      <main class="container11">
        <div class="hygiene-info">
          <div class="hygiene-icon">
            <img class="link-icon9" alt="" src="/catshopmall/img/link-12.svg" />
          </div>
          <div class="hygiene-icon1">
            <img class="link-icon9" alt="" src="/catshopmall/img/icon-13.svg" />
          </div>
          <a class="a11">  위생용품</a>
        </div>
              ...
              <div class="frame-parent14">
                ...
                <div class="item7">
                  <div class="link18">
                    ...
                    <div class="cart-icon">
                      <img class="icon48" alt="" src="/catshopmall/img/icon-72.svg" />
                    </div>
                  </div>
                </div>
                <div class="item8"></div>
                    ...
                    <div class="link19">
                      ...
                      <div class="total-payment">
                        <img
                          class="icon49"
                          alt=""
                          src="./public/icon-82@2x.png"
                        />
                      </div>
                    </div>
                    <a class="a14">최종 결제금액 </a>
                    <img class="icon50" alt="" src="/catshopmall/img/icon-91@2x.png" />

                    <div class="discount-image">
                      <img class="icon48" alt="" src="/catshopmall/img/icon-102.svg" />
                    </div>
                  </div>
                </div>
                    ...
                    <div class="selected-option">
                      <div class="selected-title">
                        <img
                          class="icon52"
                          alt=""
                          src="/catshopmall/img/icon-112@2x.png"
                        />
                        ...
                        <div class="quantity-box">
                          <div class="box-background">
                            <div class="background24">
                              <img
                                ...
                                alt=""
                                src="/catshopmall/img/circlesvg-fill.svg"
                              />
                          ...
                          <div class="instructions-icon">
                            ...
                            <div class="quantity-info">
                              <a class="a16">주문 수량안내 </a>
                              <div class="order-quantity-icon">
                                <img
                                  class="icon53"
                                  alt=""
                                  src="/catshopmall/img/icon-122@2x.png"
                                />
                              </div>
                              <div class="div75">
                                <span> 최소 주문수량 </span>
          ...
          <div class="total-price">
            <div class="price-container">
              <div class="price-value-container">
                <img class="icon54" alt="" src="/catshopmall/img/icon-132@2x.png" />
              </div>
        ...
        <img class="icon55" alt="" src="/catshopmall/img/icon-141@2x.png" />
        ...
        <div class="backgroundshadow">
          <div class="link20">
            <div class="div79"><button onclick="goToScroll('a')" />상품정보</div>
          </div>
          <div class="link21">
            <div class="div80"><button onclick="goToScroll('b')" />상품후기</div>
            <div class="tab-value-containers">
              <div class="strong">
                    <c:set var="reviewCount" value="${fn:length(listReview)}" />
    				<b class="colon"><c:out value="${reviewCount}" /></b>
              </div>
            </div>
            <div class="vertical-divider4"></div>
          </div>
          <div class="link21">
            <div class="div80"><button onclick="goToScroll('c')" />상품문의</div>
            <div class="tab-value-containers">
              <div class="strong">
                <b class="colon">0</b>
              </div>
          ...
          <div class="link23">
            <div class="div79"><button onclick="goToScroll('d')" />구매안내</div>
            <div class="vertical-divider4"></div>
          </div>
        </div>
        ...
        <img
          class="separator-icon7"
          loading="lazy"
          alt=""
          src="/catshopmall/img/separator2.svg"
        />

        <img
          class="separator-icon8"
          loading="lazy"
          alt=""
          src="/catshopmall/img/separator-11.svg"
        />

        <img
          id="a"
          class="km1907-77jpg-icon"
          loading="lazy"
          alt=""
          src="/catshopmall/img/${productView.prodDetailImgPath}"
        />

        <img
          class="separator-icon9"
          loading="lazy"
          alt=""
          src="/catshopmall/img/separator-21.svg"
        />
            ...
            <div class="review-list-content-wrapper">
              <div class="empty-review-message">
                <img
                  ...
                  loading="lazy"
                  alt=""
                  src="/catshopmall/img/icon-16.svg"
                />
              </div>
            ...
            <div class="support-link">
              <div class="link25">
                <div class="hygiene-icon1">
                  <img
                    ...
                    loading="lazy"
                    alt=""
                    src="/catshopmall/img/icon-17.svg"
                  />
                </div>
                <div class="parent3">
                  ...
                  <div class="icon-wrapper11">
                    <img
                      ...
                      loading="lazy"
                      alt=""
                      src="/catshopmall/img/icon-18.svg"
                    />
                  </div>
                </div>
              </div>
              ...
              <div class="guide">
                <div class="link26">
                  ...
                  <img class="icon60" alt="" src="./public/icon-19@2x.png" />
                </div>
              </div>
            </div>
          </div>
            ...
            <div class="leave-review">
              <div class="write-review-prompt-content">
                ...
                <img
                  ...
                  loading="lazy"
                  alt=""
                  src="/catshopmall/img/icon-20.svg"
                />
              </div>
            </div>
                ...
                <div class="link27">
                  ...
                  <div class="reviews-link-inner-container">
                    <img
                      ...
                      loading="lazy"
                      alt=""
                      src="/catshopmall/img/icon-21.svg"
                    />
                  </div>
                </div>
              </div>
            ...
            <div class="link28" id="linkContainer">
              <div class="write-review-link">
                <img
                  ...
                  loading="lazy"
                  alt=""
                  src="/catshopmall/img/icon-22.svg"
                />
              </div>
        ...
        <img
          class="separator-icon10"
          loading="lazy"
          alt=""
          src="/catshopmall/img/separator-31.svg"
        />
              ...
              <div class="discount-price-container-parent">
                ...
                <div class="paragraphhorizontalborder-wrapper">
                  <div class="paragraphhorizontalborder2">
                    ...
                    <c:set var="reviewCount" value="${fn:length(listReview)}" />
                    <b class="inquiry-review-colon1"><c:out value="${reviewCount}" /></b>
                  </div>
                </div>
              </div>
                    ...
                    <div class="minimum-quantity-value-contain">
                      ...
                      <div class="minimum-quantity-value-icon-co">
                        <img
                          class="icon53"
                          alt=""
                          src="/catshopmall/img/icon-25@2x.png"
                        />
                      </div>
                    </div>
                    <div class="div109">
                            ...
                            <div class="quantity-input-container">
                              <div class="input1">
                                  <button id="decrease-btn">-</button>
									  <div class="input-field" id="number-display">1</div>
                              ...
                              <div class="quantity-input">
                                <img
                                  class="link-icon10"
                                  alt=""
                                  src="/catshopmall/imgc/link-21@2x.png"
                                />
                              </div>
                            </div>
                    ...
                    <div class="item11">
                      <div class="container16">
                        <img
                          ...
                          loading="lazy"
                          alt=""
                          src="/catshopmall/img/icon-26.svg"
                        />
                        ...
                        <img
                          ...
                          loading="lazy"
                          alt=""
                          src="/catshopmall/img/icon-27@2x.png"
                        />
                        ...
                        <div class="link29">
                          ...
                          <img
                            class="icon69"
                            alt=""
                            src="/catshopmall/img/icon-28@2x.png"
                          />
                        </div>
                      </div>
                    </div>
                  ...
                  <div class="item13">
                    <div class="link31">
                      <img
                        ...
                        loading="lazy"
                        alt=""
                        src="/catshopmall/img/icon-72.svg"
                      />
      ...
      <div id="c"></div>
         ...
         class="prodImgPath"
          alt=""
          src="/catshopmall/img/${productView.prodImgPath}"
        />
