...
<head>
  ...
  <script src="\catshap\src\main\webap\js\buy.js"></script>
</head>
<body>
...
<!--<jsp:include page="header.jsp"></jsp:include>-->
  <main id="main">
    ...
    <section id="main6">
      <p>- 무이자할부가 적용되지 않은 상품과 무이자할부가 가능한 상품을 동시에 구매할 경우 전체 주문 상품 금액에 대해 무이자할부가 적용되지 않습니다. 무이자할부를 원하시는 경우 장바구니에서 무이자 할부 상품만 선택하여 주문하여 주시기 바랍니다.</p>
